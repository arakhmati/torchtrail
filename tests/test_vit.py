...
def test_vit_self_output(tmp_path, show_modules):
    ...
    assert len(torchtrail.get_graph(output, flatten=True)) == 7
...
def test_vit_attention(tmp_path, show_modules):
    ...
    assert len(torchtrail.get_graph(output)) == 2
    assert len(torchtrail.get_graph(output, flatten=True)) == 30
...
def test_vit_layer(tmp_path, show_modules):
    ...
    assert len(torchtrail.get_graph(output)) == 2
    assert len(torchtrail.get_graph(output, flatten=True)) == 46
...
def test_vit_encoder(tmp_path, show_modules):
    ...
    assert len(torchtrail.get_graph(output)) == 2
    assert len(torchtrail.get_graph(output, flatten=True)) == 541
...
def test_vit(tmp_path, show_modules):
    ...
    assert len(torchtrail.get_graph(output)) == 2
    assert len(torchtrail.get_graph(output, flatten=True)) == 559
