...
def test_vit_embeddings(tmp_path, trace_modules):
    ...
    torchtrail.visualize(output, file_name=tmp_path / "vit_embeddings.svg")


@pytest.mark.parametrize("trace_modules", [True, False])
def test_vit_self_attention(tmp_path, trace_modules):
    model_name = "google/vit-base-patch16-224"
    batch_size = 1
    sequence_size = 197
    hidden_size = 768
    ...
    torchtrail.visualize(output, file_name=tmp_path / "vit_self_attention.svg")


@pytest.mark.parametrize("trace_modules", [True, False])
def test_vit_self_output(tmp_path, trace_modules):
    model_name = "google/vit-base-patch16-224"
    batch_size = 1
    sequence_size = 197
    hidden_size = 768
    ...
    torchtrail.visualize(output, file_name=tmp_path / "vit_self_output.svg")


@pytest.mark.parametrize("trace_modules", [True, False])
def test_vit_attention(tmp_path, trace_modules):
    model_name = "google/vit-base-patch16-224"
    batch_size = 1
    sequence_size = 197
    hidden_size = 768
    ...
    torchtrail.visualize(output, file_name=tmp_path / "vit_attention.svg")


@pytest.mark.parametrize("trace_modules", [True, False])
def test_vit_intermediate(tmp_path, trace_modules):
    model_name = "google/vit-base-patch16-224"
    batch_size = 1
    sequence_size = 197
    hidden_size = 768
    ...
    torchtrail.visualize(output, file_name=tmp_path / "vit_intermediate.svg")


@pytest.mark.parametrize("trace_modules", [True, False])
def test_vit_layer(tmp_path, trace_modules):
    model_name = "google/vit-base-patch16-224"
    batch_size = 1
    sequence_size = 197
    hidden_size = 768
    ...
    torchtrail.visualize(output, file_name=tmp_path / "vit_layer.svg")


@pytest.mark.parametrize("trace_modules", [True, False])
def test_vit_encoder(tmp_path, trace_modules):
    model_name = "google/vit-base-patch16-224"
    batch_size = 1
    sequence_size = 197
    hidden_size = 768
    ...
    torchtrail.visualize(output, file_name=tmp_path / "vit_encoder.svg")
...
def test_vit(tmp_path, trace_modules):
    ...
    torchtrail.visualize(output, file_name=tmp_path / "vit.svg")
